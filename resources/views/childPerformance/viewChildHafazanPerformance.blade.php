                ...
                @foreach($hafazans as $key=>$hafazan)
                  {{-- @if($hafazan->week ) --}}
                    <tr>
                        ...
                        <td>{{ $hafazan->year }}</td>
                        <td>
                            <a href="{{ url('view-child-performance/' . $student->id . '/' . $hafazan->week . '/' . $hafazan->month . '/' . $hafazan->year .'/showPerformance')}}" data-toggle='tooltip' data-placement='left' title='View'>
